...
[![License: MIT](https://img.shields.io/badge/License-MIT-green.svg)](../../LICENSE.md) [![npm version](https://badge.fury.io/js/%40hendacorp%2Ftypescript-configs.svg)](https://badge.fury.io/js/%40hendacorp%2Ftypescript-configs.svg) [![npm bundle size (minified + gzip)](https://img.shields.io/bundlephobia/minzip/@hendacorp/typescript-configs.svg)](https://img.shields.io/bundlephobia/minzip/@hendacorp/typescript-configs.svg)
...
```bash
pnpm add -D @hendacorp/typescript-configs
```
...
```json
{
  "extends": "@hendacorp/typescript-configs/application.json",
  "compilerOptions": {
    "baseUrl": ".",
    "rootDir": ".",
    "paths": { "*": ["*", "app/*"] }
...
```json
{
  "extends": "@hendacorp/typescript-configs/library.json",
  "compilerOptions": {
    "baseUrl": "./src",
    "rootDir": "."
  },
...
```json
{
  "extends": "@hendacorp/typescript-configs/dom.json",
  "compilerOptions": {
    "baseUrl": ".",
    "rootDir": "."
  }
...
```json
{
  "extends": "@hendacorp/typescript-configs/base.json",
  "compilerOptions": {
    "baseUrl": ".",
    "rootDir": "."
  }
...
Run `nx build typescript-configs` to build the library.
